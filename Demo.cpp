...
{
    cout << "\n" << player.role() << " Welcome to Atlanta\n\n";
    while (true)
    {
        int c;
        int disease;
        cout << "Enter number of city and how many disease their. example: 5 3. Enter -1 to continue" << endl;
        cin >> c;
        if(c == -1){
            break;
        }
    ...
    while (flag)
    {
        ...
        Color color;
        int num;
        cout << "What do you want to do? press the matching number" << endl;
        cout << "1 - drive\n2 - fly_direct\n3 - fly_charter\n4 - fly_shuttle\n5 - build\n";
        ...
        case 6: //discover cure
            cout << "\nwhich cure you want to discover? enter the number of color:" << endl;
